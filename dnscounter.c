        ...
        if (argc <= 1){
                ...
                if (alvo == NULL) {
                    ...
                    printf("o ip do site é: %s\n",inet_ntoa(*((struct in_addr *)alvo->h_addr)));
                                ...
                                if (resposta5 ==1) {
                                                char command5[100];
                                                sprintf(command5, "for palavra in $(cat lista.txt); do if host $palavra.%s | grep -q 'has address'; then echo $palavra.%s é um domínio válido; fi; done", argv[1], argv[1]);
                                                system(command5);
                                                printf("\n");
                                } else {
                                ...
                                if (resposta6 == 1) {
                                                ...
                                                if (resposta7 == 1) {
                                                        ...
                                                        printf("Não analisar a vulnerabilidade. \n");
                                                }
